...
- **드럼 연습용 Tempo** — 정밀 클릭, 탭 템포, 박자표·세분음·박별 악센트, 갭/스피드 트레이너, 로컬 프리셋
...
Electron 상단에서 `악보 변환`과 `Tempo`를 전환할 수 있습니다. Tempo에는 BPM(20~300),
탭 템포, 박자표, 세분음, 박별 악센트/음소거, 갭 트레이너, 자동 속도 증가와 로컬 프리셋이
포함됩니다. 악보 변환 화면에는 URL·시작/종료 시각·출력 폴더·로그·취소 기능이 연결되어 있으며,
